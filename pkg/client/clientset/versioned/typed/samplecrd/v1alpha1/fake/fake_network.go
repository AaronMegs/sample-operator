...
var networksResource = schema.GroupVersionResource{Group: "samplecrd.k8s.io", Version: "v1alpha1", Resource: "networks"}

var networksKind = schema.GroupVersionKind{Group: "samplecrd.k8s.io", Version: "v1alpha1", Kind: "Network"}
