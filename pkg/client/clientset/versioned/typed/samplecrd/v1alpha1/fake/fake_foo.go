...
var foosResource = schema.GroupVersionResource{Group: "samplecrd.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "samplecrd.k8s.io", Version: "v1alpha1", Kind: "Foo"}
