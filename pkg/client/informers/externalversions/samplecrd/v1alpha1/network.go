/*
Copyright AaronMegs The Kubernetes sample-operator Authors.
...
import (
	...
	versioned "github.com/aaronmegs/sample-operator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/aaronmegs/sample-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/aaronmegs/sample-operator/pkg/client/listers/samplecrd/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecrdV1alpha1().Networks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecrdV1alpha1().Networks(namespace).Watch(context.TODO(), options)
			},
		},
		&samplecrdv1alpha1.Network{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecrdv1alpha1.Network{}, f.defaultInformer)
}
